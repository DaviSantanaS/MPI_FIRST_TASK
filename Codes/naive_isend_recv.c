...
int main(int argc, char *argv[]) {
    ...
    MPI_Status estado;
    MPI_Request req; /* Requisição para o Isend */
    ...
    if (meu_ranque == 0) {
        ...
        /* SUBSTITUÍDO: Envio Não-Bloqueante */
        MPI_Isend(&cont, 1, MPI_INT, 0, TAG_RESULTADO, MPI_COMM_WORLD, &req);
        MPI_Wait(&req, MPI_STATUS_IGNORE); /* Aguarda a mensagem sair do buffer */
    }
