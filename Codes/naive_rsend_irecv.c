...
int main(int argc, char *argv[]) {
    ...
    if (argc < 2) { return 0; }
    else { n = strtol(argv[1], (char **) NULL, 10); }
    ...
    /* Barreira antes do Rsend para alinhar todos e não quebrar a regra de ouro do MPI */
    ...
    if (meu_ranque == 0) {
        ...
        if (n >= 2) total += 1; 
        printf("=========================================\n");
        printf("[NAIVE] Quant. de primos entre 1 e %ld: %d\n", n, total);
